...
do_install:append() {
    ...
    install -m 0755 ${B}/bin/libadudiffapi.so ${D}${libdir}/
...
FILES:${PN} = "${bindir}/* ${libdir}/*.so ${prefix}/ms-adu_diffs/*"
FILES:${PN}-dev = "${includedir}/*"
FILES:${PN}-staticdev = "${libdir}/*.a"

# Disable QA checks that might fail
